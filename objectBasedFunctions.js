...
console.log(getBooksByPublisher(books, "Penguin Books"))
//------------------------------------------------------------------------------------------------------------------------------------------------
...
function getFinishedBooksFromStudent(
  ...
  books.forEach((book) => {
    if (finished.includes(book.id)) {
      result.push(book);
    }
  });
  // console.log("getFinishedBooksFromStudent", result)
  return result;
}
...
function getFinishedBooksFromStudentAdvanced(
  books = [],
  students = {},
  studentName = ""
) {
...
function hasStudentReadAllBooksFromPublisher(
  books,
  students,
  publisherName,
  studentName
...
function hasStudentReadAllBooksFromPublisherAdvanced(
  books,
  students,
  publisherName,
  studentName
...
// console.log(
//   hasStudentReadAllBooksFromPublisher(
//     books,
//     students,
//     "Simon & Schuster",
//     "Spongebob"
...
function hasStudentReadOtherStudentsUnfinishedBooks(
  students,
  studentA,
  studentB
) { }
